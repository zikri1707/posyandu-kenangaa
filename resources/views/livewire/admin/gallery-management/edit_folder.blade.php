...
<div class="max-w-3xl mx-auto space-y-8 pb-20">
    ...
    <div class="relative pl-6 mb-8">
        ...
        <h2 class="text-3xl font-black text-slate-800 tracking-tight leading-none">Edit Folder</h2>
        <p class="text-sm font-bold text-slate-400 mt-3">Perbarui nama, deskripsi, atau foto sampul untuk folder kegiatan ini.</p>
    </div>
            ...
            <div class="space-y-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $folder->name) }}" placeholder="Contoh: Imunisasi Bulan April 2026" class="w-full h-12 bg-slate-50 border-transparent focus:bg-white rounded-2xl px-5 text-sm font-semibold text-slate-700 focus:ring-0 focus:border-teal-500 transition-all border-2 border-slate-100" required>
