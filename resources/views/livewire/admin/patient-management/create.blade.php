...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-2xl font-bold">Tambah Pasien Baru</h2>
</div>
...
<x-card>
    <form wire:submit.prevent="savePatient">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <x-avatar :src="$photoPreview" size="xl" class="rounded-lg" />
                        <div>
            ...
            <div class="space-y-6">
                ...
                <x-select label="Pedukuhan" wire:model.defer="pedukuhan_id" required>
                    ...
                    @foreach($pedukuhans as $pedukuhan)
                        <option value="{{ $pedukuhan->id }}">{{ $pedukuhan->name }}</option>
                    @endforeach
                </x-select>
        ...
        <div class="flex justify-end mt-8 space-x-3">
            ...
            <x-button type="submit" variant="primary" icon="check">Simpan Pasien</x-button>
        </div>
    </form>
</x-card>
@endsection