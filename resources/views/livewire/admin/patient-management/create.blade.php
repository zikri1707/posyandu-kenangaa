...
<div class="w-full space-y-10 pb-24" 
    ...
    <div class="flex items-center justify-between px-4">
        <div class="bg-white/80 backdrop-blur-md px-8 py-4 rounded-[2rem] border border-white shadow-sm flex items-center gap-4">
            ...
            <h2 class="text-xl font-black text-slate-800 tracking-tight">Pendaftaran Warga Baru</h2>
        </div>
    ...
    <form action="{{ route('admin.patients.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col lg:flex-row gap-8 px-4">
        ...
        <div class="flex-1 space-y-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div class="lg:col-span-3 flex flex-col items-center">
                        <div class="relative group">
                            <div class="rounded-[3rem] border-2 border-dashed border-slate-200 bg-slate-50/50 flex items-center justify-center overflow-hidden transition-all duration-500 group-hover:border-primary group-hover:bg-primary/5 shadow-inner" style="width: 192px; height: 192px; flex-shrink: 0;">
                            ...
                            <label for="profile_photo" class="absolute -bottom-3 -right-3 w-14 h-14 bg-white border border-slate-100 text-slate-600 rounded-2xl flex items-center justify-center cursor-pointer shadow-xl hover:text-primary hover:scale-110 transition-all active:scale-95 group/btn">
                        ...
                        <div class="mt-8 text-center">
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Format Gambar</p>
                    ...
                    <div class="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3">
                            <div class="flex justify-between items-center ml-1">
                                <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest">NIK / No. Identitas <span class="text-primary">*</span></label>
                        ...
                        <div class="space-y-3">
                            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Nama Lengkap <span class="text-primary">*</span></label>
                        ...
                        <div class="space-y-3" x-show="category === 'ibu_hamil'">
                            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Nama Suami <span class="text-primary">*</span></label>
                            <input type="text" name="husband_name" value="{{ old('husband_name') }}" x-bind:required="category === 'ibu_hamil'"
                        ...
                        <div class="space-y-3">
                            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Tanggal Lahir <span class="text-primary">*</span></label>
                        ...
                        <div class="space-y-3">
                            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Jenis Kelamin <span class="text-primary">*</span></label>
                            ...
                            <div x-show="category !== 'ibu_hamil'">
                                <x-forms.select-input name="gender" placeholder="Pilih Jenis Kelamin" :placeholderDisabled="true" value="{{ old('gender', request('category') == 'ibu_hamil' ? 'F' : '') }}" required x-model="gender" x-bind:disabled="category === 'ibu_hamil'">
                                    <option value="M" {{ old('gender') == 'M' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="F" {{ old('gender', request('category') == 'ibu_hamil' ? 'F' : '') == 'F' ? 'selected' : '' }}>Perempuan</option>
            ...
            {{-- 3. Informasi Spesifik (Berdasarkan Kategori) --}}
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div class="space-y-3">
                        ...
                        <input type="text" name="father_name" value="{{ old('father_name') }}" placeholder="Nama ayah..."
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="mother_name" value="{{ old('mother_name') }}" placeholder="Nama ibu..."
                               class="w-full h-14 px-5 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30"
                               x-bind:disabled="!['bayi', 'baduta', 'balita', 'anak_sekolah'].includes(category)">
                    </div>
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <input type="number" step="0.01" name="weight_at_birth" value="{{ old('weight_at_birth') }}" placeholder="0.00"
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <input type="number" step="0.1" name="height_at_birth" value="{{ old('height_at_birth') }}" placeholder="0.0"
                                   class="w-full h-14 pl-5 pr-10 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30">
                    ...
                    <div class="md:col-span-2 space-y-3 pt-4">
                        ...
                        <input type="text" name="mother_nik" value="{{ old('mother_nik') }}" maxlength="16" placeholder="16 digit NIK ibu..."
                               class="w-full h-14 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30">
                    </div>
 
                    <div class="md:col-span-2 space-y-3 pt-4">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Kepemilikan Buku KIA</label>
                        <x-forms.select-input name="kia_book_ownership" placeholder="" value="{{ old('kia_book_ownership', '0') }}">
                            <option value="0" {{ old('kia_book_ownership') == '0' ? 'selected' : '' }}>Tidak Memiliki</option>
                            <option value="1" {{ old('kia_book_ownership') == '1' ? 'selected' : '' }}>Ya, Memiliki</option>
                        </x-forms.select-input>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    {{-- Pekerjaan --}}
                    <div class="space-y-3" x-data="{ currentJob: '{{ old('job', '') }}' }">
                    ...
                    <div class="space-y-3">
                        ...
                        <x-forms.select-input name="is_pregnant" placeholder="" value="{{ old('is_pregnant', request('category') == 'ibu_hamil' ? '1' : '0') }}" x-bind:disabled="category === 'ibu_hamil' || category === 'lansia' || ['bayi', 'baduta', 'balita', 'anak_sekolah'].includes(category)">
                            <option value="0" {{ old('is_pregnant') == '0' ? 'selected' : '' }}>Tidak Hamil</option>
                            <option value="1" {{ (old('is_pregnant') == '1' || request('category') == 'ibu_hamil') ? 'selected' : '' }}>Sedang Hamil</option>
                        </x-forms.select-input>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Unit Posyandu <span class="text-primary">*</span></label>
                        <div class="relative">
                            ...
                            @else
                                <x-forms.select-input name="posyandu_id" placeholder="" value="{{ old('posyandu_id', request('posyandu_id')) }}" required>
                                    @foreach($posyandus as $p)
                                        <option value="{{ $p->id }}" {{ old('posyandu_id', request('posyandu_id')) == $p->id ? 'selected' : '' }}>{{ $p->name }}</option>
                                    @endforeach
                                </x-forms.select-input>
                            @endif
                        </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="rt_domisili" value="{{ old('rt_domisili') }}"
                               placeholder="Contoh: 004 atau 011..."
                               class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30">
                    </div>
                    <div class="space-y-3" x-show="['ibu_hamil', 'lansia'].includes(category)">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">RW Domisili <span class="text-primary">*</span></label>
                        <input type="text" name="dusun_rt_rw" value="{{ old('dusun_rt_rw') }}" x-bind:required="['ibu_hamil', 'lansia'].includes(category)"
                               placeholder="Contoh: 011..."
                               class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30"
                               x-bind:disabled="!['ibu_hamil', 'lansia'].includes(category)">
                    </div>
                    <div class="space-y-3" x-show="category === 'ibu_hamil'">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Kelurahan / Desa <span class="text-primary">*</span></label>
                        <input type="text" name="desa_kelurahan" value="{{ old('desa_kelurahan') }}" x-bind:required="category === 'ibu_hamil'"
                               placeholder="Nama kelurahan/desa..."
                               class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30">
                    </div>
                    <div class="space-y-3" x-show="category === 'ibu_hamil'">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Kecamatan <span class="text-primary">*</span></label>
                        <input type="text" name="kecamatan" value="{{ old('kecamatan') }}" x-bind:required="category === 'ibu_hamil'"
                    ...
                    <div class="md:col-span-2 space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Alamat Lengkap <span class="text-primary">*</span></label>
                        <textarea name="address" rows="3" required
                                  placeholder="Nama jalan, nomor rumah, RT/RW..."
                                  class="w-full p-6 border border-slate-200 rounded-[2rem] text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30 resize-none">{{ old('address') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-3">
                        ...
                        <x-forms.select-input name="independence_status" placeholder="Pilih Status Kemandirian" value="{{ old('independence_status') }}" x-bind:disabled="category !== 'lansia'">
                            <option value="Mandiri" {{ old('independence_status') == 'Mandiri' ? 'selected' : '' }}>Mandiri (Tanpa Bantuan)</option>
                            <option value="Butuh Bantuan" {{ old('independence_status') == 'Butuh Bantuan' ? 'selected' : '' }}>Butuh Bantuan</option>
                        </x-forms.select-input>
                    </div>
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Status Tinggal</label>
                        <x-forms.select-input name="living_status" placeholder="Pilih Status Tinggal" value="{{ old('living_status') }}" x-bind:disabled="category !== 'lansia'">
                            <option value="Sendiri" {{ old('living_status') == 'Sendiri' ? 'selected' : '' }}>Tinggal Sendiri</option>
                            <option value="Dengan Keluarga" {{ old('living_status') == 'Dengan Keluarga' ? 'selected' : '' }}>Tinggal Bersama Keluarga</option>
                        </x-forms.select-input>
                    </div>
                    <div class="md:col-span-2 space-y-3">
                        ...
                        <textarea name="historical_diseases" rows="3" placeholder="Tuliskan riwayat penyakit seperti Hipertensi, Diabetes, Asam Urat..."
                                  ...
                                  x-bind:disabled="category !== 'lansia'">{{ old('historical_diseases') }}</textarea>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="space-y-3">
                        ...
                        <input type="text" name="head_of_family_name" value="{{ old('head_of_family_name') }}" placeholder="Nama kepala keluarga..."
                               class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30">
                    </div>
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Jumlah Anggota Keluarga</label>
                        <input type="number" name="family_member_count" value="{{ old('family_member_count') }}" placeholder="Contoh: 4..." min="0"
                               class="w-full h-16 px-6 border border-slate-200 rounded-2xl text-sm font-bold text-slate-700 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all bg-slate-50/30">
                    </div>
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Status Ekonomi</label>
                        <x-forms.select-input name="economic_status" placeholder="Pilih Status Ekonomi" value="{{ old('economic_status') }}">
                            <option value="Mampu" {{ old('economic_status') == 'Mampu' ? 'selected' : '' }}>Mampu</option>
                            <option value="Cukup Mampu" {{ old('economic_status') == 'Cukup Mampu' ? 'selected' : '' }}>Cukup Mampu</option>
                            <option value="Kurang Mampu" {{ old('economic_status') == 'Kurang Mampu' ? 'selected' : '' }}>Kurang Mampu</option>
                        </x-forms.select-input>
                    </div>
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Kondisi Rumah</label>
                        <x-forms.select-input name="house_condition" placeholder="Pilih Kondisi Rumah" value="{{ old('house_condition') }}">
                            <option value="Permanen" {{ old('house_condition') == 'Permanen' ? 'selected' : '' }}>Permanen (Tembok/Semen)</option>
                            <option value="Semi Permanen" {{ old('house_condition') == 'Semi Permanen' ? 'selected' : '' }}>Semi Permanen</option>
                            <option value="Non Permanen" {{ old('house_condition') == 'Non Permanen' ? 'selected' : '' }}>Non Permanen / Panggung</option>
                        </x-forms.select-input>
                    </div>
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Akses Air Bersih</label>
                        <x-forms.select-input name="water_access" placeholder="Pilih Akses Air" value="{{ old('water_access') }}">
                            <option value="PDAM" {{ old('water_access') == 'PDAM' ? 'selected' : '' }}>PDAM / Air Perpipaan</option>
                            <option value="Sumur Terlindungi" {{ old('water_access') == 'Sumur Terlindungi' ? 'selected' : '' }}>Sumur Terlindungi / Air Tanah</option>
                            <option value="Air Hujan" {{ old('water_access') == 'Air Hujan' ? 'selected' : '' }}>Penampungan Air Hujan</option>
                            <option value="Lainnya" {{ old('water_access') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </x-forms.select-input>
                    </div>
                    <div class="space-y-3">
                        <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Kepemilikan Jamban Sehat</label>
                        <x-forms.select-input name="has_latrine" placeholder="" value="{{ old('has_latrine', '1') }}">
                            <option value="1" {{ old('has_latrine', '1') == '1' ? 'selected' : '' }}>Ya, Memiliki Jamban Sehat</option>
                            <option value="0" {{ old('has_latrine') == '0' ? 'selected' : '' }}>Tidak Memiliki</option>
                        </x-forms.select-input>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between bg-white/50 backdrop-blur-md p-6 rounded-[2.5rem] border border-white shadow-xl">
                <p class="text-[10px] font-bold text-slate-400 px-6 uppercase tracking-widest hidden md:block">Pastikan seluruh data yang bertanda <span class="text-primary font-black">*</span> telah terisi dengan benar.</p>
                <div class="flex items-center gap-4 ml-auto">
                    ...
                    <x-button type="submit" variant="primary" class="!rounded-2xl h-14 !px-10 shadow-lg shadow-primary/30 font-black">
                        <span class="material-symbols-outlined mr-2">save</span> Simpan Warga Baru
                    </x-button>
                </div>
            </div>
        </div>
