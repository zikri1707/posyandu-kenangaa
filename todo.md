...
-   [ ] Tentukan service database di **docker-compose.yml** untuk PostgreSQL.
-   [ ] Sesuaikan pengaturan koneksi database di file `.env` (gunakan `DB_HOST=db` atau nama service dari Docker).
-   [ ] Jalankan perintah `docker-compose up` untuk menjalankan database container.
